document.addEventListener('DOMContentLoaded', function() {
    ...
    const textContent1 = "Hello everyone!!!";
    const textContent2 = "This is a website that I created myself with all my heart, and to hell with people's comments";
    const textContent3 = "I hope you go to hell!!";
